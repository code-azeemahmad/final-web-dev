...
function Card(props) {       // original syntax
    ...
    console.log("props: ", props.someObj);
    console.log("props: ", props.someArr);
*/

function Card({name, btnText = "default value", someObj, someArr}) {    // destructuring syntax
    ...
    <div className="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs">
        <a href="#">
          <img
            ...
            src="https://images.pexels.com/photos/32507178/pexels-photo-32507178.jpeg"
            alt=""
          />
        </a>

        <a href="#">
          <h5 className="mt-6 mb-2 text-2xl font-semibold tracking-tight text-heading text-red-600">
            Streamlining {name}'s design process today.
          </h5>
        </a>
